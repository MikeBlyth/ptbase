...
#    binding.pry
  ...
  def select
    @patient = Patient.find(params[:patient_id])
    @select_drugs = [
        {class: 'Anti-TB', drugs: %w{  Isoniazid Pyridoxine Rifampacin Pyrazinamide Ethambutol }},
        {class: 'Anti-Malaria', drugs: %w{  Chloroquine Artesunate Fansidar Quinine }},
        {class: 'OI and Misc', drugs: %w{  Septrin Multivits Fluconazole Nystatin_oral Chlorpheniramine Amoxycillin Augmentin Erythromycin Paracetamol Albendazole Griseofulvin Flagyl_amoeba Flagyl_giardia}},
        {class: 'NRTI', drugs: %w{  Zidovudine Lamivudine Stavudine Didanosine }},
        {class: 'NNRTI', drugs: %w{  Nevirapine_start Nevirapine_cont Efavirenz}},
        {class: 'Protease Inh', drugs: %w{  Kaletra }}
    ]
  end
